...
import { BookPlus, ArrowLeft, Sparkles, Save } from "lucide-react";
...
export default function CreateBook() {
  ...
  const handleSubmit = async () => {
    ...
    toast("Book added successfully to the Library!");
    navigate("/");
  };
      ...
      <div className="p-6 max-w-2xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 text-lg mb-6">
            Share a new literary adventure with your collection
          </p>
          <Link to="/">
            <Button
              variant="outline"
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <Select
                  onValueChange={(value) =>
                    setForm({ ...form, genre: value as any })
                  }
                >
